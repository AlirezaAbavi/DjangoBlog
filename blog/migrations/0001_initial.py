# Generated by Django 4.0.6 on 2022-10-05 18:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status',
                 models.CharField(choices=[('d', 'Draft'), ('p', 'Publish'), ('r', 'Reviewing'), ('b', 'Denied')],
                                  max_length=1)),
                ('author',
                 models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='articles',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(blank=True, editable=False, max_length=100, null=True)),
        ...
        migrations.AddField(
            model_name='article',
            name='hits',
            field=models.ManyToManyField(blank=True, related_name='hits', through='blog.ArticleHit',
                                         to='blog.ipaddress'),
        ),
    ]
